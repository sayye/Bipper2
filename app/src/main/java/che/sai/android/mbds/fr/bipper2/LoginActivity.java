...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Login, Void, Login> {


        @Override
        protected Login doInBackground(Login... logins) {
            ...
            try {
                ...
                if(success){
                    ...
                    person.setNom(user.getString("nom"));
                    person.setPrenom(user.getString("prenom"));
                    person.setSexe(user.getString("sexe"));
                    person.setTelephone(user.getInt("telephone"));
                    person.setEmail(user.getString("email"));
                    person.setCreatedBy(user.getString("createdby"));
                    person.setPassword(user.getString("password"));
                    person.setConnected(user.getBoolean("connected"));
                    person.setCreatedAt(user.getString("createdAt"));
                    person.setUpdateAt(user.getString("updatedAt"));
                    person.setId(user.getString("id"));
                }else{
                    message= json.getString("message");
                }

            } catch (Exception e) {
                message="Problème serveur. Merci de contacter l'administrateur.";
            }
